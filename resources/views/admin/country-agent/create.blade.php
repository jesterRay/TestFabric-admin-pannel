...
@section('title', 'Add Country Agent')
  ...
  <div class="col-12 mb-6">
    <div class="card mb-6">
        <div class="card-body pt-4">
          <div class="card-title text-primary h4 mb-6">Create Country Agent</div>
          <form method="POST" action='{{ route('country-agent.save') }}' enctype="multipart/form-data">
            @csrf
            <div class="row g-6">
                <!-- Name -->
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <textarea 
                        ...
                        name="agent__Address" 
                        rows="3" 
                        required>{{ old('agent__Address') }}</textarea>
                </div>
