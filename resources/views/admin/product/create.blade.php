  ...
  <div class="col-12 mb-6">
    <div class="card mb-6">
        <div class="card-body pt-4">
          <div class="card-title text-primary h4 mb-6">Create Product</div>
            ...
            <div class="row g-6">
                ...
                <div class="col-12">
                    ...
                    <textarea 
                        ...
                        rows="4" 
                        required>{{ old('product__Description') }}</textarea>
                </div>
                ...
                <div class="col-md-6">
                    <x-select-two-drop-down
                        ...
                        placeholder="Select..."
                        :options="$categories"
                        :selected="old('product__Category_Name')"
                        :multiple="false"
                    />
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input 
                        ...
                        value="{{ old('product__Weight_gm_m2') }}" 
                        required
                    />
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input 
                        ...
                        value="{{ old('product__Weight_Oz_yd2') }}" 
                        required
                    />
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input 
                        ...
                        value="{{ old('product__Width_Inches') }}" 
                        required
                    />
                </div>
                ...
                <div class="col-md-6">
                    <x-select-two-drop-down
                        ...
                        placeholder="Select..."
                        :options="$availableIn"
                        :selected="old('product__Available')"
                        :multiple="false"
                ...
                <!-- Product Image -->
                <div class="col-md-6">
                    <label for="product__image" class="form-label">Product Image *</label>
                    <div class="my-3">
                ...
                <div class="col-md-6">
                    <label for="product__image" class="form-label">Product Image *</label>
                    <div class="my-3">
                        <img id="imgPreview_a" src="#" alt="Selected Image" style="display: none; max-width: 100%; height: auto;" />
                    </div>
                    <input 
                        class="form-control" 
                        type="file" 
                ...
                <div class="col-md-6">
                    <label for="product__image" class="form-label">Product Image *</label>
                    <div class="my-3">
                        <img id="imgPreview_b" src="#" alt="Selected Image" style="display: none; max-width: 100%; height: auto;" />
                    </div>
                    <input 
                        class="form-control" 
                        type="file" 
                ...
                <div class="col-md-6">
                    <label for="product__image" class="form-label">Product Image *</label>
                    <div class="my-3">
                        <img id="imgPreview_c" src="#" alt="Selected Image" style="display: none; max-width: 100%; height: auto;" />
                    </div>
                    <input  
                        class="form-control" 
                        type="file" 
