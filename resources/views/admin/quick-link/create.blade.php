  ...
  <div class="col-12 mb-6">
    <div class="card mb-6">
        <div class="card-body pt-4">
          <div class="card-title text-primary h4 mb-6">Create Quick Link</div>
          <form method="POST" action='{{route('quick-link.save')}}'>
            @csrf
            <div class="row g-6">
                <div class="col-md-6">
