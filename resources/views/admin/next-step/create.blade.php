  ...
  <div class="col-12 mb-6">
    <div class="card mb-6">
        <div class="card-body pt-4">
          <div class="card-title text-primary h4 mb-6">Create Next Step</div>
          <form method="POST" action='{{route('next-step.save')}}'  enctype="multipart/form-data">
            @csrf
            <div class="row g-6">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input 
                    ...
                    value="{{old('associations_and_partners__Abbriviation')}}" 
                    required
                />
              </div>
              <div class="col-12">
