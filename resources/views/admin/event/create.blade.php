    ...
    <div class="col-12 mb-6">
        <div class="card mb-6">
            <div class="card-body pt-4">
                <div class="card-title text-primary h4 mb-6">Create Event</div>
                    ...
                    <div class="row g-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input 
                                ...
                                value="{{ old('events__Abbriviation') }}" 
                                required 
                            />
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea 
                                ...
                                rows="4" 
                                required
                            >{{ old('events__Description') }}</textarea>
                        </div>
