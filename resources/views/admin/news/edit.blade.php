  ...
  <div class="col-12 mb-6">
    <div class="card mb-6">
        <div class="card-body pt-4">
          <div class="card-title text-primary h4 mb-6">Edit News</div>
          <form method="POST" action='{{route('news.update', ['id' => $news->news__ID])}}' enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row g-6">
                <div class="col-md-6">
                    ...
                    <input 
                        ...
                        id="news__Title" 
                        name="news__Title" 
                        value="{{ old('news__Title') ?? $news->news__Title }}" 
                        required
                    />
                </div>
                <div class="col-md-6">
                    ...
                    <input 
                        ...
                        id="news__Date" 
                        name="news__Date" 
                        value="{{ old('news__Date') ?? $news->news__Date }}" 
                        required
                    />
                </div>
                <div class="col-md-6">
                    <x-select-two-drop-down
                        ...
                        :selected="old('news__Status', $news->news__Status)"
                        :multiple="false"
                    />
                </div>
                ...
                <div class="col-md-12 mt-3">
                    ...
                    <textarea 
                        ...
                        rows="4">{{ old('news__Short_Description') ?? $news->news__Short_Description }}</textarea>
                </div>
                ...
                <div class="col-md-12 mt-3">
                    ...
                    <textarea 
                        ...
                        rows="6">{{ old('news__Long_Description') ?? $news->news__Long_Description }}</textarea>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="my-3">
                            <img id="imgPreview" 
                                alt="Preview" 
                                style="{{ isset($news->imgfile) && $news->imgfile ? 'display: block;' : 'display: none;' }} max-width: 100%; height: auto;"
                                src="{{ isset($news->imgfile) && $news->imgfile ? asset($news->imgfile) : '#' }}" 
                            />
                        </div>
                        <input 
                            class="form-control" 
